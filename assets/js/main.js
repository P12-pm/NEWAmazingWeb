...
(function($) {
	...
	jQuery(document).ready(function() {
		...
		if ($(".mobile-menu").length) {
			...
			$(".mobile-menu .mobile-menu__list").append(mobileMenuContent);

			var mobileMenuOptions = $(".cmn-nav .navbar__mobile-options").html();
			$(".mobile-menu .mobile-menu__options").append(mobileMenuOptions);
		...
		// 17. footer copyright text
		$(".footer__copyright-text p").html('&copy; 2021 Amazing Webtech. All Rights Reserved');
